...
public class DashboardPage {
    ...
    public static final Target MAIN_TITLE =
            Target.the("Open Demo Account").located(By.id("net.metaquotes.metatrader5:id/main_title"));
    public static final Target MAIN_NAVIGATE_BUTTON =
            Target.the("hamburger button").located(By.id("net.metaquotes.metatrader5:id/actionbar_back_icon"));
